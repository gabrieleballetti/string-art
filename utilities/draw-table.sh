...
# 1. Make string art images
for op in $(seq 0.3 -0.05 0.1); do \
    for t in $(seq -w 245 5 265); do \
        ../bin/string-art.exe ../cat.pgm 256 ${op} ${t} 32 temp.pgm
        magick convert -resize 256x256 temp.pgm ${op}_${t}.png
        rm temp.pgm
    done
done
...
magick montage \
    ...
    -tile 5x5 -geometry 128x128+4+4 table.png
